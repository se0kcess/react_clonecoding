...
export default function GlobalSettingMenu({ closeMenu }: GlobalSettingMenuProps) {
    ...
    <div className={style.overlay}>
      <div className={style.GlobalSettingMenu}>
        ...
        <div className={style.globalSettingTabMenuCon}>
          <div className={style.globalSettingMenu}>
            <p onClick={() => setTabMenu('언어와 지역')}
              className={tabMenu === '언어와 지역' ? style.on : ''}>언어와 지역</p>
            <p onClick={() => setTabMenu('통화')}
              className={tabMenu === '통화' ? style.on : ''}>통화</p>
          </div>
          {tabMenu === '언어와 지역' ? (
